    ...
    >
      ...
      <div className="hero-content content-grid">
        <div className="hero-title-wrap">
          <p className="hero-meta eyebrow">
            {cinematicMedia.hero.eyebrow}
          </p>

          <h1 className="hero-title">
            {cinematicMedia.hero.title.map(
              (line: string) => (
                <span
        ...
        <aside className="hero-side">
          <p className="hero-meta hero-side-kicker">
            PROPIEDADES EXTRAORDINARIAS
          </p>

          <p className="hero-meta hero-side-copy">
            Seleccionamos espacios donde arquitectura,
            ubicación y forma de vida encuentran un
            mismo lenguaje.
          </p>

          <a
            className="hero-meta text-link"
            href="#propiedades"
          >
